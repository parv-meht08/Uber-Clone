  ...
  return (
    <div>
      ...
      <div className="flex gap-2 flex-col justify-between items-center mb-3">
        ...
        <div className="flex mt-5 w-full items-center justify-between gap-2">
        <button
          onClick={() => {props.setConfirmRidePopupPanel(true)}}
          className="bg-yellow-400 text-black font-semibold p-3 px-8 rounded-lg"
        >
          Accept
        </button>
        ...
        <button
          ...
          className="mt-1 bg-gray-300 font-semibold p-3 px-8 rounded-lg"
        >
          Ignore
        </button>
        </div>
